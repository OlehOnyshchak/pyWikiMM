...
* [WikiImageRecommendation](https://github.com/OlehOnyshchak/WikiImageRecommendation) - multimodal learning model to reccommend relevant images for a Wikipedia article, which was trained on data collected with pyWikiMM library.
